        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 mb-3 md:mb-4">
              A Dynamic View of Cliftonville Gardens
            </h2>
            <p className="text-slate-600 text-base md:text-lg max-w-2xl mx-auto">
              Explore our beautiful community through these captivating images showcasing the elegance and comfort of Cliftonville Gardens
            </p>
          </motion.div>
